...
- [Binance Futures Trading Bot](https://github.com/JunaidAhamed-7777/trading_bot/tree/main) — Python CLI trading bot that safely validate, execute, and log market and limit orders on the Binance USDT Futures Testnet.
---
